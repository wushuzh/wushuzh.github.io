...
> 当下软件的 32 bit 的版本上用 x86 标识，64 bit 的版本用 x64 标识。历史渊源大概是这样:

> 早先 IBM PC 使用的 CPU 是 16 bit，型号包括 8086、8088、80186、80286 , 后来 Intel 开发出首个 32 bit CPU 即 80386 可以让先前为 16 bit 的软件兼容运行，业界就普遍将这些 CPU 称为 80x86, 后此后性能不断攀升, Intel 索性把 80 去掉，直接将新产品叫做 486、586 ... Intel 终于开发了 64 bit ，命名为 IA64，并同时将 x86 叫做 IA32。然而这次 IA64 居然无法兼容 IA32 / x86，结果大家都不买。AMD 推出的可以兼容 x86 的 64 bit CPU，于是命名为 x86-64 , 结果大获成功。
> 
